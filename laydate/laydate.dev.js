...
Dates.events = function(){
    ...
    Dates.each(S('#laydate_table td'), function(i, elem){
        Dates.on(elem, 'click', function(ev){
            ...
            /*dns时间圈显示*/
            if($("#dns5").val()!=""&&$("#dns5").val()!=null){
            	$("#dns5").next("div").removeClass("DNS-tb").addClass("DNS-tb1");
            }
            if($("#dns6").val()!=""&&$("#dns5").val()!=null){
            	$("#dns6").next("div").removeClass("DNS-tb").addClass("DNS-tb1");
            }
            /*dns时间圈显示*/
            
            /*高级查询时间圈显示*/
            if($("#entTime1").val()==""&&$("#entTime2").val()==""){
            	 $("#entTime1").parent().next().removeClass("gjcx-tb2");
			     $("#entTime1").parent().next().addClass("gjcx-tb1");

		}else{
				 $("#entTime1").parent().next().removeClass("gjcx-tb1");
		         $("#entTime1").parent().next().addClass("gjcx-tb2");
			};
            /*高级查询时间圈显示*/
        });
    });
    ...
    Dates.on(as.oclear, 'click', function(){
        ...
        /*dns时间圈显示*/
        if($("#dns5").val()==""||$("#dns5").val()==null){
        	$("#dns5").next("div").removeClass("DNS-tb1").addClass("DNS-tb");
        }
        if($("#dns6").val()==""||$("#dns5").val()==null){
        	$("#dns6").next("div").removeClass("DNS-tb1").addClass("DNS-tb");
        }
        /*dns时间圈显示*/
        /*高级查询时间圈显示*/
        if($("#entTime1").val()==""&&$("#entTime2").val()==""){
