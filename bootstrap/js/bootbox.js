  ...
  var templates = {
    dialog:
      "<div class='bootbox modal' tabindex='-1' role='dialog'>" +
        ...
        "<div class='modal-dialog' style='margin-top: 3%;height: 331px;width: 536px;'>" +
          "<div class='modal-content' style='height:331px'>" +
            "<div class='modal-header'>" +
    		  "<h4 class='modal-title' style='font-size:16px;text-indent:20px;'>提示</h4>" +
    		  "<button type='button' class='bootbox-close-button close' style='margin-top:-19px'>&times;</button>"+
    		"</div>" +
            "<div class='modal-body' style='padding-top:95px;padding-bottom:95px;font-size:16px;text-align:center;'><div class='bootbox-body'></div></div>" +
          "</div>" +
        "</div>" +
      "</div>",
    header:
